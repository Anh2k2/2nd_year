...
with (document) {
	...
	if (NS4) {
		...
		write(".child { text-decoration:none; font-size:9pt; line-height:15pt; position:absolute }");
	        write(".item { COLOR: #000000; TEXT-DECORATION: none }");
	        write(".highlight { BACKGROUND: #ffcc00; COLOR: #000000; TEXT-DECORATION: none }");
	}
	else {
		write(".parent { font: 12px; Arial; text-decoration: none; color: black }");
		write(".child { font:12px  Arial; display:none }");
	        write(".item { font: 12px  Arial; COLOR: #000000; TEXT-DECORATION: none; cursor: hand }");
	        write(".highlight { font:12px  Arial; BACKGROUND: #ffcc00; COLOR: #000000; TEXT-DECORATION: none }");
